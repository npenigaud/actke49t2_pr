...
LOGICAL :: LRMESOQ, LRMESOT, LRMESOU, LRQREL, LRTREL, LRUREL, LRVREL
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RMESOU), CDPATH//'%RMESOU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RMESOT), CDPATH//'%RMESOT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RMESOQ), CDPATH//'%RMESOQ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RUREL), CDPATH//'%RUREL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RVREL), CDPATH//'%RVREL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RTREL), CDPATH//'%RTREL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RQREL), CDPATH//'%RQREL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RFMESOQ), CDPATH//'%RFMESOQ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTQSAT), CDPATH//'%NTQSAT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTDIFU), CDPATH//'%NTDIFU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTCOEF), CDPATH//'%NTCOEF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTDRAG), CDPATH//'%NTDRAG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTCVIM), CDPATH//'%NTCVIM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NT850), CDPATH//'%NT850'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NT950), CDPATH//'%NT950'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTPLUI), CDPATH//'%NTPLUI'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTRADI), CDPATH//'%NTRADI'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTNEBU), CDPATH//'%NTNEBU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTOZON), CDPATH//'%NTOZON'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTDRME), CDPATH//'%NTDRME'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTCOET), CDPATH//'%NTCOET'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTAJUC), CDPATH//'%NTAJUC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTRELAXT), CDPATH//'%NTRELAXT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTRELAXQ), CDPATH//'%NTRELAXQ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTRELAXU), CDPATH//'%NTRELAXU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CHEM_HPSC_NTOP), CDPATH//'%CHEM_HPSC_NTOP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CHEM_HPSC_NBOT), CDPATH//'%CHEM_HPSC_NBOT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CHEM_HOXF_NBOT), CDPATH//'%CHEM_HOXF_NBOT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CHEM_ELEM_NTOP), CDPATH//'%CHEM_ELEM_NTOP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CHEM_RELA_NIV), CDPATH//'%CHEM_RELA_NIV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CHEM_NO_NIV), CDPATH//'%CHEM_NO_NIV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETQSAT), CDPATH//'%ETQSAT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETDIFU), CDPATH//'%ETDIFU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETCOEF), CDPATH//'%ETCOEF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETDRAG), CDPATH//'%ETDRAG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETCVIM), CDPATH//'%ETCVIM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ET850), CDPATH//'%ET850'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ET950), CDPATH//'%ET950'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETPLUI), CDPATH//'%ETPLUI'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETRADI), CDPATH//'%ETRADI'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETNEBU), CDPATH//'%ETNEBU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETOZON), CDPATH//'%ETOZON'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETDRME), CDPATH//'%ETDRME'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETCOET), CDPATH//'%ETCOET'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETAJUC), CDPATH//'%ETAJUC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETRELAXT), CDPATH//'%ETRELAXT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETRELAXQ), CDPATH//'%ETRELAXQ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETRELAXU), CDPATH//'%ETRELAXU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMUK), CDPATH//'%XDRMUK'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMUX), CDPATH//'%XDRMUX'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMUP), CDPATH//'%XDRMUP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMTK), CDPATH//'%XDRMTK'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMTX), CDPATH//'%XDRMTX'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMTP), CDPATH//'%XDRMTP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMQK), CDPATH//'%XDRMQK'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMQP), CDPATH//'%XDRMQP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDRMQX), CDPATH//'%XDRMQX'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RCLX), CDPATH//'%RCLX'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%TPSCLIM), CDPATH//'%TPSCLIM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETELEM), CDPATH//'%ETELEM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETRELA), CDPATH//'%ETRELA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETPSCT), CDPATH//'%ETPSCT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETPSCB), CDPATH//'%ETPSCB'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETHOXF), CDPATH//'%ETHOXF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ETCHEMNO), CDPATH//'%ETCHEMNO'
