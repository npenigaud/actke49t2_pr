...
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTSHM), CDPATH//'%NTSHM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTSML), CDPATH//'%NTSML'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%TSPHY), CDPATH//'%TSPHY'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XMUCVPP), CDPATH//'%XMUCVPP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XMULAF), CDPATH//'%XMULAF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDAMP), CDPATH//'%XDAMP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HCLP), CDPATH//'%HCLP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HTCLS), CDPATH//'%HTCLS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HVCLS), CDPATH//'%HVCLS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HTSHM), CDPATH//'%HTSHM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HTSML), CDPATH//'%HTSML'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HWMOHIGH), CDPATH//'%HWMOHIGH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HWMOLOW), CDPATH//'%HWMOLOW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%GZ0RAF), CDPATH//'%GZ0RAF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%FACRAF), CDPATH//'%FACRAF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%FACRAFCV), CDPATH//'%FACRAFCV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%FACRAFDCAPE), CDPATH//'%FACRAFDCAPE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%GCAPERAF), CDPATH//'%GCAPERAF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HTKERAF), CDPATH//'%HTKERAF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LRAFTUR), CDPATH//'%LRAFTUR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LMULAF), CDPATH//'%LMULAF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LWMOCLOUD), CDPATH//'%LWMOCLOUD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LRAFTKE), CDPATH//'%LRAFTKE'
