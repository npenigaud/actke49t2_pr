...
alloc (ZDCIS, 1,1, KLON,KLEV)
alloc (ZDTH2, 1,1, KLON,KLEV)
alloc (ZDTH, 1,1, KLON,KLEV)
alloc (ZRI, 1,0, KLON,KLEV)
alloc (ZTHETAVL, 1,1, KLON,KLEV)
alloc (ZFH_CLOUD, 1,1, KLON,KLEV)
alloc (ZFH_CLEAR, 1,1, KLON,KLEV)
alloc (ZFM_CLOUD, 1,1, KLON,KLEV)
alloc (ZFM_CLEAR, 1,1, KLON,KLEV)
alloc (ZLUPH_CLOUD, 1,1, KLON,KLEV)
alloc (ZLUPH_CLEAR, 1,1, KLON,KLEV)
alloc (ZLUPM_CLOUD, 1,1, KLON,KLEV)
alloc (ZLUPM_CLEAR, 1,1, KLON,KLEV)
alloc (ZLDNH_CLOUD, 1,1, KLON,KLEV)
alloc (ZLDNH_CLEAR, 1,1, KLON,KLEV)
alloc (ZLDNM_CLOUD, 1,1, KLON,KLEV)
alloc (ZLDNM_CLEAR, 1,1, KLON,KLEV)
alloc (ZLSH_CLOUD, 1,1, KLON,KLEV)
alloc (ZLSH_CLEAR, 1,1, KLON,KLEV)
alloc (ZLSM_CLOUD, 1,1, KLON,KLEV)
alloc (ZLSM_CLEAR, 1,1, KLON,KLEV)
alloc (ZLINTH_CLOUD, 1,1, KLON,KLEV)
alloc (ZLINTH_CLEAR, 1,1, KLON,KLEV)
alloc (ZLINTM_CLOUD, 1,1, KLON,KLEV)
alloc (ZLINTM_CLEAR, 1,1, KLON,KLEV)
alloc (ZLENDH_CLEAR, 1,1, KLON,KLEV)
alloc (ZLENDM_CLEAR, 1,1, KLON,KLEV)
alloc (ZLENDH_CLOUD, 1,1, KLON,KLEV)
alloc (ZLENDM_CLOUD, 1,1, KLON,KLEV)
alloc (ZLENDMM, 1,1, KLON,KLEV)
alloc (ZTHETA, 1,1, KLON,KLEV)
alloc (ZLENDH, 1,1, KLON,KLEV)
alloc (ZLENDM, 1,1, KLON,KLEV)
alloc (ZRIF, 1,1, KLON,KLEV)
alloc (ZNN_CLOUD, 1,0, KLON,KLEV)
alloc (ZNN_CLEAR, 1,0, KLON,KLEV)
alloc (ZGLMINF, 1,1, KLON,KLEV)
alloc (ZLMIN, 1,1, KLON,KLEV)
alloc (ZQVS, 1,1, KLON,KLEV)
alloc (ZLH, 1,1, KLON,KLEV)
alloc (ZCPH, 1,1, KLON,KLEV)
alloc (ZRH, 1,1, KLON,KLEV)
alloc (ZQL, 1,1, KLON,KLEV)
alloc (ZQV, 1,1, KLON,KLEV)
alloc (ZTHUC, 1,1, KLON,KLEV)
alloc (ZTHDC, 1,1, KLON,KLEV)
alloc (ZTHU, 1,1, KLON,KLEV)
alloc (ZTHD, 1,1, KLON,KLEV)
alloc (ZQSEUIL, 1,1, KLON,KLEV)
alloc (ZRIF2, 1,1, KLON,KLEV)
alloc (ZRI2, 1,0, KLON,KLEV)
alloc (ZDELTQH, 1,1, KLON,KLEV)
alloc (ZAA, 1,1, KLON,KLEV)
alloc (ZIGMAS_CLEAR, 1,1, KLON,KLEV)
alloc (ZIGMAS_CLOUD, 1,1, KLON,KLEV)
alloc (ZQVL, 1,1, KLON,KLEV)
alloc (ZNEBI, 1,1, KLON,KLEV)
alloc (ZNEB, 1,1, KLON,KLEV)
alloc (ZG2LD2, 1,1, KLON,KLEV)
