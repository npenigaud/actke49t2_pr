...
temp (REAL (KIND=JPRB), ZDCIS, (:, :))
temp (REAL (KIND=JPRB), ZDTH2, (:, :))
temp (REAL (KIND=JPRB), ZDTH, (:, :))
temp (REAL (KIND=JPRB), ZRI, (:, :))
temp (REAL (KIND=JPRB), ZTHETAVL, (:, :))

temp (REAL (KIND=JPRB), ZFH_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZFH_CLEAR, (:, :))
temp (REAL (KIND=JPRB), ZFM_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZFM_CLEAR, (:, :))

temp (REAL (KIND=JPRB), ZLUPH_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLUPH_CLEAR, (:, :))
temp (REAL (KIND=JPRB), ZLUPM_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLUPM_CLEAR, (:, :))

temp (REAL (KIND=JPRB), ZLDNH_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLDNH_CLEAR, (:, :))
temp (REAL (KIND=JPRB), ZLDNM_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLDNM_CLEAR, (:, :))

temp (REAL (KIND=JPRB), ZLSH_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLSH_CLEAR, (:, :))
temp (REAL (KIND=JPRB), ZLSM_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLSM_CLEAR, (:, :))

temp (REAL (KIND=JPRB), ZLINTH_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLINTH_CLEAR, (:, :))
temp (REAL (KIND=JPRB), ZLINTM_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLINTM_CLEAR, (:, :))

temp (REAL (KIND=JPRB), ZLENDH_CLEAR, (:, :))
temp (REAL (KIND=JPRB), ZLENDM_CLEAR, (:, :))

temp (REAL (KIND=JPRB), ZLENDH_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZLENDM_CLOUD, (:, :))

temp (REAL (KIND=JPRB), ZLENDMM, (:, :))
temp (REAL (KIND=JPRB), ZTHETA, (:, :))
temp (REAL (KIND=JPRB), ZLENDH, (:, :))
temp (REAL (KIND=JPRB), ZLENDM, (:, :))

temp (REAL (KIND=JPRB), ZRIF, (:, :))
temp (REAL (KIND=JPRB), ZNN_CLOUD, (:, :))
temp (REAL (KIND=JPRB), ZNN_CLEAR, (:, :))

temp (REAL (KIND=JPRB), ZGLMINF, (:, :))
temp (REAL (KIND=JPRB), ZLMIN, (:, :))
...
temp (REAL (KIND=JPRB), ZQVS, (:, :))
temp (REAL (KIND=JPRB), ZLH, (:, :))
temp (REAL (KIND=JPRB), ZCPH, (:, :))
temp (REAL (KIND=JPRB), ZRH, (:, :))
temp (REAL (KIND=JPRB), ZQL, (:, :))
temp (REAL (KIND=JPRB), ZQV, (:, :))

temp (REAL (KIND=JPRB), ZTHUC, (:, :))
temp (REAL (KIND=JPRB), ZTHDC, (:, :))
temp (REAL (KIND=JPRB), ZTHU, (:, :))
temp (REAL (KIND=JPRB), ZTHD, (:, :))
temp (REAL (KIND=JPRB), ZQSEUIL, (:, :))

temp (REAL (KIND=JPRB), ZRIF2, (:, :))
temp (REAL (KIND=JPRB), ZRI2, (:, :))
...
temp (REAL (KIND=JPRB), ZDELTQH, (:, :))
temp (REAL (KIND=JPRB), ZAA, (:, :))
temp (REAL (KIND=JPRB), ZIGMAS_CLEAR, (:, :))
temp (REAL (KIND=JPRB), ZIGMAS_CLOUD, (:, :))

temp (REAL (KIND=JPRB), ZQVL, (:, :))
temp (REAL (KIND=JPRB), ZNEBI, (:, :))
temp (REAL (KIND=JPRB), ZNEB, (:, :))
...
alloc2d (ZDCIS, 1,1, KLON,KLEV)
alloc2d (ZDTH2, 1,1, KLON,KLEV)
alloc2d (ZDTH, 1,1, KLON,KLEV)
alloc2d (ZRI, 1,0, KLON,KLEV)
alloc2d (ZTHETAVL, 1,1, KLON,KLEV)
alloc2d (ZFH_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZFH_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZFM_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZFM_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLUPH_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLUPH_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLUPM_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLUPM_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLDNH_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLDNH_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLDNM_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLDNM_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLSH_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLSH_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLSM_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLSM_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLINTH_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLINTH_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLINTM_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLINTM_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLENDH_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLENDM_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZLENDH_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLENDM_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZLENDMM, 1,1, KLON,KLEV)
alloc2d (ZTHETA, 1,1, KLON,KLEV)
alloc2d (ZLENDH, 1,1, KLON,KLEV)
alloc2d (ZLENDM, 1,1, KLON,KLEV)
alloc2d (ZRIF, 1,1, KLON,KLEV)
alloc2d (ZNN_CLOUD, 1,0, KLON,KLEV)
alloc2d (ZNN_CLEAR, 1,0, KLON,KLEV)
alloc2d (ZGLMINF, 1,1, KLON,KLEV)
alloc2d (ZLMIN, 1,1, KLON,KLEV)
alloc2d (ZQVS, 1,1, KLON,KLEV)
alloc2d (ZLH, 1,1, KLON,KLEV)
alloc2d (ZCPH, 1,1, KLON,KLEV)
alloc2d (ZRH, 1,1, KLON,KLEV)
alloc2d (ZQL, 1,1, KLON,KLEV)
alloc2d (ZQV, 1,1, KLON,KLEV)
alloc2d (ZTHUC, 1,1, KLON,KLEV)
alloc2d (ZTHDC, 1,1, KLON,KLEV)
alloc2d (ZTHU, 1,1, KLON,KLEV)
alloc2d (ZTHD, 1,1, KLON,KLEV)
alloc2d (ZQSEUIL, 1,1, KLON,KLEV)
alloc2d (ZRIF2, 1,1, KLON,KLEV)
alloc2d (ZRI2, 1,0, KLON,KLEV)
alloc2d (ZDELTQH, 1,1, KLON,KLEV)
alloc2d (ZAA, 1,1, KLON,KLEV)
alloc2d (ZIGMAS_CLEAR, 1,1, KLON,KLEV)
alloc2d (ZIGMAS_CLOUD, 1,1, KLON,KLEV)
alloc2d (ZQVL, 1,1, KLON,KLEV)
alloc2d (ZNEBI, 1,1, KLON,KLEV)
alloc2d (ZNEB, 1,1, KLON,KLEV)
alloc2d (ZG2LD2, 1,1, KLON,KLEV)
