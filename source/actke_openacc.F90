...
alloc (ZPHI3, 1,1, KLON,KLEV)
alloc (ZLMECT, 1,1, KLON,KLEV)
alloc (ZUSLE, 1,1, KLON,KLEV)
alloc (ZPRDY, 1,1, KLON,KLEV)
alloc (ZPRODTH, 1,1, KLON,KLEV)
alloc (ZDIAG, 1,1, KLON,KLEV)
alloc (ZDISS, 1,1, KLON,KLEV)
alloc (ZDIFF, 1,1, KLON,KLEV)
alloc (ZECT1, 1,1, KLON,KLEV)
alloc (ZECT, 1,1, KLON,KLEV)
alloc (ZDELPSG, 1,1, KLON,KLEV)
alloc (ZDET, 1,1, KLON,KLEV)
alloc1d (ZECTCLS, 1, KLON)
alloc1d (ZKCLS, 1, KLON)
alloc (ZDIFFAR, 1,1, KLON,KLEV)
alloc (ZTABFL, 1,1, KLON,KLEV)
alloc (ZTABHL, 1,0, KLON,KLEV)
alloc (ZFCORTKE, 1,0, KLON,KLEV)
alloc (ZFDIFF, 1,0, KLON,KLEV)
alloc (ZFDISS, 1,0, KLON,KLEV)
alloc (ZFPRDY, 1,0, KLON,KLEV)
alloc (ZFPRTH, 1,0, KLON,KLEV)
alloc (ZEDR, 1,1, KLON,KLEV)
alloc (ZTCORTKE, 1,1, KLON,KLEV)
alloc (ZTDIFF, 1,1, KLON,KLEV)
alloc (ZTDISS, 1,1, KLON,KLEV)
alloc (ZTPRTH, 1,1, KLON,KLEV)
alloc (LLCONV, 1,1, KLON,KLEV)
