...
alloc2d (ZRTV, 1,1, KLON,KLEV)
alloc2d (ZZ, 1,1, KLON,KLEV)
alloc2d (ZGDZF, 1,1, KLON,KLEV)
alloc2d (ZTHETA, 1,1, KLON,KLEV)
alloc2d (ZLOCPEXF, 1,1, KLON,KLEV)
alloc2d (ZTHETALF, 1,1, KLON,KLEV)
alloc2d (ZTHETAVL, 1,1, KLON,KLEV)
alloc2d (ZECTF, 1,1, KLON,KLEV)
alloc2d (ZLMECTF, 1,1, KLON,KLEV)
alloc2d (ZGKTF, 1,1, KLON,KLEV)
alloc2d (ZGKUH, 1,0, KLON,KLEV)
alloc2d (ZGKTH, 1,0, KLON,KLEV)
alloc2d (ZLM, 1,0, KLON,KLEV)
alloc2d (ICM, 1,1, KLON,KLEV)
alloc2d (ZAH, 1,1, KLON,KLEV)
alloc2d (ZQSLTLH, 1,1, KLON,KLEV)
