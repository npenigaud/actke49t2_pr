...
REAL (KIND=JPRB)::ZCOR 
temp (REAL (KIND=JPRB), ZGKEF, (:, :))
temp (REAL (KIND=JPRB), ZDET, (:, :))
temp (REAL (KIND=JPRB), ZGKU, (:, :))
temp (REAL (KIND=JPRB), ZPA, (:, :))
temp (REAL (KIND=JPRB), ZE, (:, :))
temp (REAL (KIND=JPRB), ZA, (:, :))
...
alloc2d (ZGKEF, 1,1, KLON,KLEV)
alloc2d (ZDET, 1,1, KLON,KLEV)
alloc2d (ZGKU, 1,0, KLON,KLEV)
alloc2d (ZPA, 1,1, KLON,KLEV)
alloc2d (ZE, 1,1, KLON,KLEV)
alloc2d (ZA, 1,1, KLON,KLEV)
