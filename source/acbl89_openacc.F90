...
temp (REAL (KIND=JPRB), ZGDZH, (:, :))
temp (REAL (KIND=JPRB), ZGDZF, (:, :))

temp (REAL (KIND=JPRB), ZDTHETA, (:, :))
temp (REAL (KIND=JPRB), ZTHETA, (:, :))
temp (REAL (KIND=JPRB), ZTHETAH, (:, :))
temp (REAL (KIND=JPRB), ZTHETAP, (:, :))
...
temp (REAL (KIND=JPRB), ZPHIH, (:, :))
temp (REAL (KIND=JPRB), ZGLMDN, (:, :))
temp (REAL (KIND=JPRB), ZGLMUP, (:, :))
...
alloc (ZGDZH, 1,1, KLON,KLEV)
alloc (ZGDZF, 1,1, KLON,KLEV)
alloc (ZDTHETA, 1,1, KLON,KLEV)
alloc (ZTHETA, 1,1, KLON,KLEV)
!call stack_alloc_r8_2_p(ztheta,(/1,1/),(/klon,klev/),YLSTACK,int1,kidia)
!call stack_alloc_r8_2_p2(ztheta,1,1,klon,klev,YLSTACK,int1,kidia)
!call stack_alloc_r8_2(ztheta,(/1,1/),(/klon,klev/),YLSTACK)
alloc (ZTHETAH, 1,0, KLON,KLEV)
alloc (ZTHETAP, 1,1, KLON,KLEV)
alloc (ZPHIH, 1,1, KLON,KLEV)
alloc (ZGLMDN, 1,1, KLON,KLEV)
alloc (ZGLMUP, 1,1, KLON,KLEV)
