...
alloc2d (ZGDZH, 1,1, KLON,KLEV)
alloc2d (ZGDZF, 1,1, KLON,KLEV)
alloc2d (ZDTHETA, 1,1, KLON,KLEV)
alloc2d (ZTHETA, 1,1, KLON,KLEV)
alloc2d (ZTHETAH, 1,0, KLON,KLEV)
alloc2d (ZTHETAP, 1,1, KLON,KLEV)
alloc2d (ZPHIH, 1,1, KLON,KLEV)
alloc2d (ZGLMDN, 1,1, KLON,KLEV)
alloc2d (ZGLMUP, 1,1, KLON,KLEV)
