SUBROUTINE ACTKE ( YDCST, &
& YDLDDH, YDMDDH, &
& YDML_PHY_MF, KIDIA, KFDIA, KLON, KTDIAT, KTDIAN, KLEV,      &
...
& PXUROV, PNBVNO,  PNEBS, PQCS, PNEBS0, PQCS0, PCOEFN, PFECT, PFECTI, PECT1, PTPRDY, PEDR)
...
INTEGER(KIND=JPIM) :: ILCONV(KLON,KLEV)
...
DO JLEV = 1, KLEV
  DO JLON = KIDIA, KFDIA
    PNEBS0(JLON,JLEV)=PNEBS(JLON,JLEV)
