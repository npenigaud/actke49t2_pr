...
#define alloc4(n, sh, sz) n sh => YSTACK%ZDATA4 (:,YLSTACK%L4+1:YLSTACK%L4+sz); YLSTACK%L4=YLSTACK%L4+(SIZE(n,KIND=8)/SIZE(YSTACK%ZDATA4,1));IF(YLSTACK%L4>YLSTACK%U4)CALL ABOR1_ACC(__FILE__)
#define alloc8(n, sh, sz) n sh => YSTACK%ZDATA8 (:,YLSTACK%L8+1:YLSTACK%L8+sz); YLSTACK%L8=YLSTACK%L8+(SIZE(n,KIND=8)/SIZE(YSTACK%ZDATA8,1));IF(YLSTACK%L8>YLSTACK%U8)CALL ABOR1_ACC(__FILE__)
