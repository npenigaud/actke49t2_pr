...
LNSLSTA = ALLOCATED (YD%NSLSTA)
IF (LNSLSTA) THEN
  GPU_CREATE(YD%NSLSTA)
  GPU_UPDATE_DEVICE(YD%NSLSTA)
  GPU_ATTACH(YD%NSLSTA)
ENDIF

LNSLONL = ALLOCATED (YD%NSLONL)
IF (LNSLONL) THEN
  GPU_CREATE(YD%NSLONL)
  GPU_UPDATE_DEVICE(YD%NSLONL)
  GPU_ATTACH(YD%NSLONL)
ENDIF

LNSLOFF = ALLOCATED (YD%NSLOFF)
IF (LNSLOFF) THEN
  GPU_CREATE(YD%NSLOFF)
  GPU_UPDATE_DEVICE(YD%NSLOFF)
  GPU_ATTACH(YD%NSLOFF)
ENDIF

LNSLPTSWEST = ALLOCATED (YD%NSLPTSWEST)
IF (LNSLPTSWEST) THEN
  GPU_CREATE(YD%NSLPTSWEST)
  GPU_UPDATE_DEVICE(YD%NSLPTSWEST)
  GPU_ATTACH(YD%NSLPTSWEST)
ENDIF

LNSLPTSEAST = ALLOCATED (YD%NSLPTSEAST)
IF (LNSLPTSEAST) THEN
  GPU_CREATE(YD%NSLPTSEAST)
  GPU_UPDATE_DEVICE(YD%NSLPTSEAST)
  GPU_ATTACH(YD%NSLPTSEAST)
ENDIF

LNSLEXT = ALLOCATED (YD%NSLEXT)
IF (LNSLEXT) THEN
  GPU_CREATE(YD%NSLEXT)
  GPU_UPDATE_DEVICE(YD%NSLEXT)
  GPU_ATTACH(YD%NSLEXT)
ENDIF

LLCOMPLAT = ALLOCATED (YD%LCOMPLAT)
IF (LLCOMPLAT) THEN
  GPU_CREATE(YD%LCOMPLAT)
  GPU_UPDATE_DEVICE(YD%LCOMPLAT)
  GPU_ATTACH(YD%LCOMPLAT)
ENDIF

LNLATGLO = ALLOCATED (YD%NLATGLO)
IF (LNLATGLO) THEN
  GPU_CREATE(YD%NLATGLO)
  GPU_UPDATE_DEVICE(YD%NLATGLO)
  GPU_ATTACH(YD%NLATGLO)
ENDIF

LDIST1GP = ALLOCATED (YD%DIST1GP)
IF (LDIST1GP) THEN
  GPU_CREATE(YD%DIST1GP)
  GPU_UPDATE_DEVICE(YD%DIST1GP)
  GPU_ATTACH(YD%DIST1GP)
ENDIF

LNSLSENDPOS = ALLOCATED (YD%NSLSENDPOS)
IF (LNSLSENDPOS) THEN
  GPU_CREATE(YD%NSLSENDPOS)
  GPU_UPDATE_DEVICE(YD%NSLSENDPOS)
  GPU_ATTACH(YD%NSLSENDPOS)
ENDIF

LNSLRECVPOS = ALLOCATED (YD%NSLRECVPOS)
IF (LNSLRECVPOS) THEN
  GPU_CREATE(YD%NSLRECVPOS)
  GPU_UPDATE_DEVICE(YD%NSLRECVPOS)
  GPU_ATTACH(YD%NSLRECVPOS)
ENDIF

LNSLSENDPTR = ALLOCATED (YD%NSLSENDPTR)
IF (LNSLSENDPTR) THEN
  GPU_CREATE(YD%NSLSENDPTR)
  GPU_UPDATE_DEVICE(YD%NSLSENDPTR)
  GPU_ATTACH(YD%NSLSENDPTR)
ENDIF

LNSLRECVPTR = ALLOCATED (YD%NSLRECVPTR)
IF (LNSLRECVPTR) THEN
  GPU_CREATE(YD%NSLRECVPTR)
  GPU_UPDATE_DEVICE(YD%NSLRECVPTR)
  GPU_ATTACH(YD%NSLRECVPTR)
ENDIF

LNSLCOMM = ALLOCATED (YD%NSLCOMM)
IF (LNSLCOMM) THEN
  GPU_CREATE(YD%NSLCOMM)
  GPU_UPDATE_DEVICE(YD%NSLCOMM)
  GPU_ATTACH(YD%NSLCOMM)
ENDIF

LLSLCOMM = ALLOCATED (YD%LSLCOMM)
IF (LLSLCOMM) THEN
  GPU_CREATE(YD%LSLCOMM)
  GPU_UPDATE_DEVICE(YD%LSLCOMM)
  GPU_ATTACH(YD%LSLCOMM)
ENDIF
...
LNSLMAP = ALLOCATED (YD%NSLMAP)
IF (LNSLMAP) THEN
  GPU_CREATE(YD%NSLMAP)
  GPU_UPDATE_DEVICE(YD%NSLMAP)
  GPU_ATTACH(YD%NSLMAP)
ENDIF

LNSLCORE = ALLOCATED (YD%NSLCORE)
IF (LNSLCORE) THEN
  GPU_CREATE(YD%NSLCORE)
  GPU_UPDATE_DEVICE(YD%NSLCORE)
  GPU_ATTACH(YD%NSLCORE)
ENDIF

LLSLCORE = ALLOCATED (YD%LSLCORE)
IF (LLSLCORE) THEN
  GPU_CREATE(YD%LSLCORE)
  GPU_UPDATE_DEVICE(YD%LSLCORE)
  GPU_ATTACH(YD%LSLCORE)
ENDIF
...
LNLOENG = ALLOCATED (YD%NLOENG)
IF (LNLOENG) THEN
  GPU_CREATE(YD%NLOENG)
  GPU_UPDATE_DEVICE(YD%NLOENG)
  GPU_ATTACH(YD%NLOENG)
ENDIF


LNSTALAT = ALLOCATED (YD%NSTALAT)
IF (LNSTALAT) THEN
  GPU_CREATE(YD%NSTALAT)
  GPU_UPDATE_DEVICE(YD%NSTALAT)
  GPU_ATTACH(YD%NSTALAT)
ENDIF

LNADDR = ALLOCATED (YD%NADDR)
IF (LNADDR) THEN
  GPU_CREATE(YD%NADDR)
  GPU_UPDATE_DEVICE(YD%NADDR)
  GPU_ATTACH(YD%NADDR)
ENDIF

LNOFFLEV = ALLOCATED (YD%NOFFLEV)
IF (LNOFFLEV) THEN
  GPU_CREATE(YD%NOFFLEV)
  GPU_UPDATE_DEVICE(YD%NOFFLEV)
  GPU_ATTACH(YD%NOFFLEV)
ENDIF

LRLSDEPI = ALLOCATED (YD%RLSDEPI)
IF (LRLSDEPI) THEN
  GPU_CREATE(YD%RLSDEPI)
  GPU_UPDATE_DEVICE(YD%RLSDEPI)
  GPU_ATTACH(YD%RLSDEPI)
ENDIF

LNSLEXTPOLFISTA = ALLOCATED (YD%NSLEXTPOLFISTA)
IF (LNSLEXTPOLFISTA) THEN
  GPU_CREATE(YD%NSLEXTPOLFISTA)
  GPU_UPDATE_DEVICE(YD%NSLEXTPOLFISTA)
  GPU_ATTACH(YD%NSLEXTPOLFISTA)
ENDIF

LNSLEXTPOLIJPTA = ALLOCATED (YD%NSLEXTPOLIJPTA)
IF (LNSLEXTPOLIJPTA) THEN
  GPU_CREATE(YD%NSLEXTPOLIJPTA)
  GPU_UPDATE_DEVICE(YD%NSLEXTPOLIJPTA)
  GPU_ATTACH(YD%NSLEXTPOLIJPTA)
ENDIF

LNSLEXTPOLIPTA = ALLOCATED (YD%NSLEXTPOLIPTA)
IF (LNSLEXTPOLIPTA) THEN
  GPU_CREATE(YD%NSLEXTPOLIPTA)
  GPU_UPDATE_DEVICE(YD%NSLEXTPOLIPTA)
  GPU_ATTACH(YD%NSLEXTPOLIPTA)
ENDIF
...
LOGICAL :: LNSLEXT, LNSLEXTPOLFISTA, LNSLEXTPOLIJPTA, LNSLEXTPOLIPTA, LNSLMAP, LNSLOFF, LNSLONL, LNSLPTSEAST, LNSLPTSWEST, LNSLRECVPOS
LOGICAL :: LNSLRECVPTR, LNSLSENDPOS, LNSLSENDPTR, LNSLSTA, LNSTALAT, LRLSDEPI
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CVER), CDPATH//'%CVER'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLGROUP), CDPATH//'%NSLGROUP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLSTA), CDPATH//'%NSLSTA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLONL), CDPATH//'%NSLONL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLOFF), CDPATH//'%NSLOFF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLPTSWEST), CDPATH//'%NSLPTSWEST'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLPTSEAST), CDPATH//'%NSLPTSEAST'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLEXT), CDPATH//'%NSLEXT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LCOMPLAT), CDPATH//'%LCOMPLAT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLATGLO), CDPATH//'%NLATGLO'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%DIST1GP), CDPATH//'%DIST1GP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLSENDPOS), CDPATH//'%NSLSENDPOS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLRECVPOS), CDPATH//'%NSLRECVPOS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLSENDPTR), CDPATH//'%NSLSENDPTR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLRECVPTR), CDPATH//'%NSLRECVPTR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLCOMM), CDPATH//'%NSLCOMM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LSLCOMM), CDPATH//'%LSLCOMM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NASLB1), CDPATH//'%NASLB1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NASLMASK), CDPATH//'%NASLMASK'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NASLB1_TRUE), CDPATH//'%NASLB1_TRUE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLPAD), CDPATH//'%NSLPAD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LSLT_ARRAYS_INIT), CDPATH//'%LSLT_ARRAYS_INIT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LSLONDEM), CDPATH//'%LSLONDEM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LSLONDEM_ACTIVE), CDPATH//'%LSLONDEM_ACTIVE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NUNUSEDHALO), CDPATH//'%NUNUSEDHALO'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%DISTUNUSEDHALO), CDPATH//'%DISTUNUSEDHALO'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLPROCS), CDPATH//'%NSLPROCS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLRPT), CDPATH//'%NSLRPT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLSPT), CDPATH//'%NSLSPT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLWIDEN), CDPATH//'%NSLWIDEN'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLWIDES), CDPATH//'%NSLWIDES'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLWIDEE), CDPATH//'%NSLWIDEE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLWIDEW), CDPATH//'%NSLWIDEW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLWIDE), CDPATH//'%NSLWIDE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLMAP), CDPATH//'%NSLMAP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLCORE), CDPATH//'%NSLCORE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LSLCORE), CDPATH//'%LSLCORE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGLG), CDPATH//'%NDGLG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDLON), CDPATH//'%NDLON'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGSAG), CDPATH//'%NDGSAG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGENG), CDPATH//'%NDGENG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGSAL), CDPATH//'%NDGSAL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGENL), CDPATH//'%NDGENL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGSAH), CDPATH//'%NDGSAH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGENH), CDPATH//'%NDGENH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NGPTOT), CDPATH//'%NGPTOT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGUXL), CDPATH//'%NDGUXL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDLUNG), CDPATH//'%NDLUNG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDLUXG), CDPATH//'%NDLUXG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGUNG), CDPATH//'%NDGUNG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGUXG), CDPATH//'%NDGUXG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDSUR1), CDPATH//'%NDSUR1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDLSUR), CDPATH//'%NDLSUR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDGSUR), CDPATH//'%NDGSUR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NPTRFLOFF), CDPATH//'%NPTRFLOFF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NFRSTLOFF), CDPATH//'%NFRSTLOFF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%MYFRSTACTLAT), CDPATH//'%MYFRSTACTLAT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%MYLSTACTLAT), CDPATH//'%MYLSTACTLAT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLOENG), CDPATH//'%NLOENG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NPROC), CDPATH//'%NPROC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSTALAT), CDPATH//'%NSTALAT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NADDR), CDPATH//'%NADDR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NOFFLEV), CDPATH//'%NOFFLEV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RLSDEPI), CDPATH//'%RLSDEPI'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLEXTPOLFISTA), CDPATH//'%NSLEXTPOLFISTA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLEXTPOLIJPTA), CDPATH//'%NSLEXTPOLIJPTA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSLEXTPOLIPTA), CDPATH//'%NSLEXTPOLIPTA'
...
LNSLSTA = ALLOCATED (YD%NSLSTA)
IF (LNSLSTA) THEN
  GPU_DETACH(YD%NSLSTA)
  GPU_DELETE(YD%NSLSTA)
ENDIF

LNSLONL = ALLOCATED (YD%NSLONL)
IF (LNSLONL) THEN
  GPU_DETACH(YD%NSLONL)
  GPU_DELETE(YD%NSLONL)
ENDIF

LNSLOFF = ALLOCATED (YD%NSLOFF)
IF (LNSLOFF) THEN
  GPU_DETACH(YD%NSLOFF)
  GPU_DELETE(YD%NSLOFF)
ENDIF

LNSLPTSWEST = ALLOCATED (YD%NSLPTSWEST)
IF (LNSLPTSWEST) THEN
  GPU_DETACH(YD%NSLPTSWEST)
  GPU_DELETE(YD%NSLPTSWEST)
ENDIF

LNSLPTSEAST = ALLOCATED (YD%NSLPTSEAST)
IF (LNSLPTSEAST) THEN
  GPU_DETACH(YD%NSLPTSEAST)
  GPU_DELETE(YD%NSLPTSEAST)
ENDIF

LNSLEXT = ALLOCATED (YD%NSLEXT)
IF (LNSLEXT) THEN
  GPU_DETACH(YD%NSLEXT)
  GPU_DELETE(YD%NSLEXT)
ENDIF

LLCOMPLAT = ALLOCATED (YD%LCOMPLAT)
IF (LLCOMPLAT) THEN
  GPU_DETACH(YD%LCOMPLAT)
  GPU_DELETE(YD%LCOMPLAT)
ENDIF

LNLATGLO = ALLOCATED (YD%NLATGLO)
IF (LNLATGLO) THEN
  GPU_DETACH(YD%NLATGLO)
  GPU_DELETE(YD%NLATGLO)
ENDIF

LDIST1GP = ALLOCATED (YD%DIST1GP)
IF (LDIST1GP) THEN
  GPU_DETACH(YD%DIST1GP)
  GPU_DELETE(YD%DIST1GP)
ENDIF

LNSLSENDPOS = ALLOCATED (YD%NSLSENDPOS)
IF (LNSLSENDPOS) THEN
  GPU_DETACH(YD%NSLSENDPOS)
  GPU_DELETE(YD%NSLSENDPOS)
ENDIF

LNSLRECVPOS = ALLOCATED (YD%NSLRECVPOS)
IF (LNSLRECVPOS) THEN
  GPU_DETACH(YD%NSLRECVPOS)
  GPU_DELETE(YD%NSLRECVPOS)
ENDIF

LNSLSENDPTR = ALLOCATED (YD%NSLSENDPTR)
IF (LNSLSENDPTR) THEN
  GPU_DETACH(YD%NSLSENDPTR)
  GPU_DELETE(YD%NSLSENDPTR)
ENDIF

LNSLRECVPTR = ALLOCATED (YD%NSLRECVPTR)
IF (LNSLRECVPTR) THEN
  GPU_DETACH(YD%NSLRECVPTR)
  GPU_DELETE(YD%NSLRECVPTR)
ENDIF

LNSLCOMM = ALLOCATED (YD%NSLCOMM)
IF (LNSLCOMM) THEN
  GPU_DETACH(YD%NSLCOMM)
  GPU_DELETE(YD%NSLCOMM)
ENDIF

LLSLCOMM = ALLOCATED (YD%LSLCOMM)
IF (LLSLCOMM) THEN
  GPU_DETACH(YD%LSLCOMM)
  GPU_DELETE(YD%LSLCOMM)
ENDIF
...
LNSLMAP = ALLOCATED (YD%NSLMAP)
IF (LNSLMAP) THEN
  GPU_DETACH(YD%NSLMAP)
  GPU_DELETE(YD%NSLMAP)
ENDIF

LNSLCORE = ALLOCATED (YD%NSLCORE)
IF (LNSLCORE) THEN
  GPU_DETACH(YD%NSLCORE)
  GPU_DELETE(YD%NSLCORE)
ENDIF

LLSLCORE = ALLOCATED (YD%LSLCORE)
IF (LLSLCORE) THEN
  GPU_DETACH(YD%LSLCORE)
  GPU_DELETE(YD%LSLCORE)
ENDIF
...
LNLOENG = ALLOCATED (YD%NLOENG)
IF (LNLOENG) THEN
  GPU_DETACH(YD%NLOENG)
  GPU_DELETE(YD%NLOENG)
ENDIF


LNSTALAT = ALLOCATED (YD%NSTALAT)
IF (LNSTALAT) THEN
  GPU_DETACH(YD%NSTALAT)
  GPU_DELETE(YD%NSTALAT)
ENDIF
...
LNOFFLEV = ALLOCATED (YD%NOFFLEV)
IF (LNOFFLEV) THEN
  GPU_DETACH(YD%NOFFLEV)
  GPU_DELETE(YD%NOFFLEV)
ENDIF

LRLSDEPI = ALLOCATED (YD%RLSDEPI)
IF (LRLSDEPI) THEN
  GPU_DETACH(YD%RLSDEPI)
  GPU_DELETE(YD%RLSDEPI)
ENDIF

LNSLEXTPOLFISTA = ALLOCATED (YD%NSLEXTPOLFISTA)
IF (LNSLEXTPOLFISTA) THEN
  GPU_DETACH(YD%NSLEXTPOLFISTA)
  GPU_DELETE(YD%NSLEXTPOLFISTA)
ENDIF

LNSLEXTPOLIJPTA = ALLOCATED (YD%NSLEXTPOLIJPTA)
IF (LNSLEXTPOLIJPTA) THEN
  GPU_DETACH(YD%NSLEXTPOLIJPTA)
  GPU_DELETE(YD%NSLEXTPOLIJPTA)
ENDIF

LNSLEXTPOLIPTA = ALLOCATED (YD%NSLEXTPOLIPTA)
IF (LNSLEXTPOLIPTA) THEN
  GPU_DETACH(YD%NSLEXTPOLIPTA)
  GPU_DELETE(YD%NSLEXTPOLIPTA)
ENDIF
