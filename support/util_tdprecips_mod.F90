...
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HDPRECIPS), CDPATH//'%HDPRECIPS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%HDCLWC), CDPATH//'%HDCLWC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RDHAIL1), CDPATH//'%RDHAIL1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RDHAIL2), CDPATH//'%RDHAIL2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RDSEUIL1), CDPATH//'%RDSEUIL1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RDSEUIL2), CDPATH//'%RDSEUIL2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RDSEUIL3), CDPATH//'%RDSEUIL3'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RDSEUIL4), CDPATH//'%RDSEUIL4'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RDSEUIL5), CDPATH//'%RDSEUIL5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RDCLWC), CDPATH//'%RDCLWC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RPRECSEUIL), CDPATH//'%RPRECSEUIL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RHTOP), CDPATH//'%RHTOP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RTPW), CDPATH//'%RTPW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RAWARM), CDPATH//'%RAWARM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RAWARM2), CDPATH//'%RAWARM2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RACOLD), CDPATH//'%RACOLD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RACOLD2), CDPATH//'%RACOLD2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDTPREC), CDPATH//'%NDTPREC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDTPREC2), CDPATH//'%NDTPREC2'
