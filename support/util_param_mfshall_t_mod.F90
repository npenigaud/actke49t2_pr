...
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XIMPL_MF), CDPATH//'%XIMPL_MF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CMF_UPDRAFT), CDPATH//'%CMF_UPDRAFT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CMF_CLOUD), CDPATH//'%CMF_CLOUD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LMIXUV), CDPATH//'%LMIXUV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LMF_FLX), CDPATH//'%LMF_FLX'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XALP_PERT), CDPATH//'%XALP_PERT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XABUO), CDPATH//'%XABUO'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XBENTR), CDPATH//'%XBENTR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XBDETR), CDPATH//'%XBDETR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCMF), CDPATH//'%XCMF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XENTR_MF), CDPATH//'%XENTR_MF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCRAD_MF), CDPATH//'%XCRAD_MF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XENTR_DRY), CDPATH//'%XENTR_DRY'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDETR_DRY), CDPATH//'%XDETR_DRY'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XDETR_LUP), CDPATH//'%XDETR_LUP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XKCF_MF), CDPATH//'%XKCF_MF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XKRC_MF), CDPATH//'%XKRC_MF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XTAUSIGMF), CDPATH//'%XTAUSIGMF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XPRES_UV), CDPATH//'%XPRES_UV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XALPHA_MF), CDPATH//'%XALPHA_MF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XSIGMA_MF), CDPATH//'%XSIGMA_MF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XFRAC_UP_MAX), CDPATH//'%XFRAC_UP_MAX'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XA1), CDPATH//'%XA1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XB), CDPATH//'%XB'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XC), CDPATH//'%XC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XBETA1), CDPATH//'%XBETA1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XR), CDPATH//'%XR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LGZ), CDPATH//'%LGZ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XGZ), CDPATH//'%XGZ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LTHETAS_MF), CDPATH//'%LTHETAS_MF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XLAMBDA_MF), CDPATH//'%XLAMBDA_MF'
