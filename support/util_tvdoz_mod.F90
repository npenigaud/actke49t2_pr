...
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDHJS), CDPATH//'%VDHJS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDHJH), CDPATH//'%VDHJH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDHNS), CDPATH//'%VDHNS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDHNH), CDPATH//'%VDHNH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDPJS), CDPATH//'%VDPJS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDPJH), CDPATH//'%VDPJH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDPNS), CDPATH//'%VDPNS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDPNH), CDPATH//'%VDPNH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDEJS), CDPATH//'%VDEJS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDEJH), CDPATH//'%VDEJH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDENS), CDPATH//'%VDENS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDENH), CDPATH//'%VDENH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDAJS), CDPATH//'%VDAJS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDAJH), CDPATH//'%VDAJH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDANS), CDPATH//'%VDANS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDANH), CDPATH//'%VDANH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDNJS), CDPATH//'%VDNJS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDNJH), CDPATH//'%VDNJH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDNNS), CDPATH//'%VDNNS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VDNNH), CDPATH//'%VDNNH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VOZNJ), CDPATH//'%VOZNJ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%VOZHS), CDPATH//'%VOZHS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LRDIFOZ), CDPATH//'%LRDIFOZ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LRDEPOZ), CDPATH//'%LRDEPOZ'
