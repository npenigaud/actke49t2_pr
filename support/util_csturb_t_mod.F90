...
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCMFS), CDPATH//'%XCMFS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCMFB), CDPATH//'%XCMFB'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCPR2), CDPATH//'%XCPR2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCPR3), CDPATH//'%XCPR3'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCPR4), CDPATH//'%XCPR4'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCPR5), CDPATH//'%XCPR5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCET), CDPATH//'%XCET'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCDP), CDPATH//'%XCDP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCDD), CDPATH//'%XCDD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCDT), CDPATH//'%XCDT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XRM17), CDPATH//'%XRM17'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XLINF), CDPATH//'%XLINF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XALPSBL), CDPATH//'%XALPSBL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCEP), CDPATH//'%XCEP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XA0), CDPATH//'%XA0'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XA2), CDPATH//'%XA2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XA3), CDPATH//'%XA3'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XA5), CDPATH//'%XA5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XCTD), CDPATH//'%XCTD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XPHI_LIM), CDPATH//'%XPHI_LIM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XSBL_O_BL), CDPATH//'%XSBL_O_BL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%XFTOP_O_FSURF), CDPATH//'%XFTOP_O_FSURF'
