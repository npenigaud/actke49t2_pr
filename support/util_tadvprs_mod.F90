...
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LLMELTS), CDPATH//'%LLMELTS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LLFREEZ), CDPATH//'%LLFREEZ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LLEVAPX), CDPATH//'%LLEVAPX'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZEPS), CDPATH//'%ZEPS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZNU1), CDPATH//'%ZNU1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZNU2), CDPATH//'%ZNU2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZTAU1), CDPATH//'%ZTAU1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZTAU2), CDPATH//'%ZTAU2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZSIGMA1), CDPATH//'%ZSIGMA1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZSIGMA2), CDPATH//'%ZSIGMA2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZFVENTR1), CDPATH//'%ZFVENTR1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZFVENTR2), CDPATH//'%ZFVENTR2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZFVENTS1), CDPATH//'%ZFVENTS1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZFVENTS2), CDPATH//'%ZFVENTS2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZFVELR), CDPATH//'%ZFVELR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZFVELS), CDPATH//'%ZFVELS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZTMELT), CDPATH//'%ZTMELT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZRHOW), CDPATH//'%ZRHOW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZNRHOW), CDPATH//'%ZNRHOW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZDVISC), CDPATH//'%ZDVISC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZSQTVIS), CDPATH//'%ZSQTVIS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZCDARV), CDPATH//'%ZCDARV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZRHOREF), CDPATH//'%ZRHOREF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZEXP1), CDPATH//'%ZEXP1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZEXP4), CDPATH//'%ZEXP4'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZEXP6), CDPATH//'%ZEXP6'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZPREF), CDPATH//'%ZPREF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZCOEFF1), CDPATH//'%ZCOEFF1'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZCOEFF2), CDPATH//'%ZCOEFF2'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZCOEFF2B), CDPATH//'%ZCOEFF2B'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZCOEFF3), CDPATH//'%ZCOEFF3'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZCOEFF4), CDPATH//'%ZCOEFF4'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZCOEFF5), CDPATH//'%ZCOEFF5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%ZCOEFF6), CDPATH//'%ZCOEFF6'
